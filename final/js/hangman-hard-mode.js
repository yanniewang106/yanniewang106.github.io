window.onload = function()
{
  ...
  var selectCat = function()
  {
    ...
    {
      catagoryName.innerHTML = "Category: Fruits";
    }
    else if (chosenCategory === categories[7])
    {
      catagoryName.innerHTML = "Category: Music";
    }
  ...
  play = function()
  {
    categories = [
        ...
        ["DURIAN", "COCONUT", "TANGERINE", "KIWI", "POME-GRANATE", "RASPBERRY", "LEMON"],
        ["BANG-MY-HEAD", "WHAT-MAKES-YOU-BEAUTIFUL", "BEST-SONG-EVER", "LOVE-ME-LIKE-YOU-DO", "CHANDELIER"],
        ["WHO-WANTS-TO-BE-A-MILLIONAIRE", "ARE-YOU-SMARTER-THAN-A-FIFTH-GRADER", "MASTER-CHEF", "AMERICAN-IDOL", "THE-VOICE"]
    ];
  ...
  // hint
    hint.onclick = function()
    {
      hints = [
        ...
        ["smells stinky", "beach", "juice", "green inside, brown outside..", "contains lots of vitamins", "kind of berries", "evil"],
        ["David Guetta", "One Direction", "One Direction", "Fifty Shades of Grey", "Sia"],
        ["earn lots of money if you win", "old vs. young", "kitchen activity", "sing", "singing competition"]
    ];
